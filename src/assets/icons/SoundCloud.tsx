...
export type SoundCloudProps = SVGProps<SVGSVGElement> & {
  size?: number | string;
};
 ...
 * underlying <svg>. Fill-based (brand glyph), inherits `currentColor`.
 */
const SoundCloud = forwardRef<SVGSVGElement, SoundCloudProps>(
